...
@if ($crud->hasAccess('unlockmembershipfeeregistration'))
    <a
        href="javascript:void(0)"
        onclick="unlockMembershipFeeRegistration(this)"
        data-route="{{ url($crud->route.'/'.$entry->getKey().'/unlockmembershipfeeregistration') }}"
        class="btn btn-sm btn-link"
        data-toggle="tooltip"
        title="Otključaj članarinu"
    >
        <i class="la la-2x la-money" style="vertical-align:middle;"></i>
    </a>
@endif
