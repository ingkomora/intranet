...
@role('admin')
<li class="nav-item nav-dropdown">
    <a class="nav-link nav-dropdown-toggle" href="#"><i class="nav-icon la la-certificate"></i>ADMIN</a>
    <ul class="nav-dropdown-items">
        <li class="nav-item nav-dropdown">
...
<li class="nav-item nav-dropdown">
    <a class="nav-link nav-dropdown-toggle" href="#"><i class="nav-icon la la-certificate"></i>PRIJAVE</a>
    <ul class="nav-dropdown-items">
        ...
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('sikandidat') }}'><i class='nav-icon la la-question'></i> SiKandidati</a></li>
    </ul>
</li>
@endrole

@role('si|urednik|admin')
<li class="nav-item nav-dropdown">
    <a class="nav-link nav-dropdown-toggle" href="#"><i class="nav-icon la la-certificate"></i>STRUČNI ISPITI</a>
    <ul class="nav-dropdown-items">
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('siprijava') }}'><i class='nav-icon fa fa-address-book'></i> Prijave</a></li>
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('prijavasistara') }}'><i class='nav-icon la la-question'></i> Prijave stare</a></li>
