        ...
        <table class="table table-sm table-hover">
            ...
            @forelse($rows as $date => $row)
                <tr>
                    ...
                    @endforeach
                    <td class="text-right">
                        <a href="{{ route('log-viewer::logs.show', [$date]) }}" class="btn btn-sm btn-link">
                            <i class="la la-search"></i>
                        </a>
                        <a href="{{ route('log-viewer::logs.download', [$date]) }}" class="btn btn-sm btn-link">
                            <i class="la la-download"></i>
                        </a>
                        <a href="#delete-log-modal" class="btn btn-sm btn-link" data-log-date="{{ $date }}">
